...
//     const [selectedPermission, setSelectedPermission] = useState(null); // Selected permission for details
...
//     // Open the details modal for a specific permission
...
//                         <div className="modal-content">
//                             <div className="modal-header">
//                                 <h5 className="modal-title">Details for {selectedPermission.name}</h5>
//                                 <button
//                                     type="button"
//                                     className="btn-close"
//                                     aria-label="Close"
